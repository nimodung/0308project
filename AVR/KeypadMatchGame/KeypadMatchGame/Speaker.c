...
int right_tune[] = {DO_05, MI_05, SOL_05, DO_06, '/0'};

int right_beat[] = {BEAT_1_8, BEAT_1_8, BEAT_1_8, BEAT_1_4};

int fail_tune[] = {DO_06, SI_05, DO_06, SI_05, '/0'};
	
int fail_beat[] = {BEAT_1_8, BEAT_1_8, BEAT_1_8, BEAT_1_8};
